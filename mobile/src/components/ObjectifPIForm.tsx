...
export function ObjectifPIForm({ visible, objectif, defaultPi, onClose, onSave, onDelete }: Props) {
  const empty = (): ObjectifPIInput => ({ titre: '', pi: defaultPi, type: 'engage', valeur_prevue: '', valeur_obtenue: '' });
